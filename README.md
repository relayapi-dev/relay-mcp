...
[![NPM version](<https://img.shields.io/npm/v/@relayapi/api.svg?label=npm%20(stable)>)](https://npmjs.org/package/@relayapi/api) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@relayapi/api)
...
```ts
import Relay from 'npm:@relayapi/api';
