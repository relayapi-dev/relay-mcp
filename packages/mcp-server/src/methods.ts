...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.whatsapp.contacts.create',
    fullyQualifiedName: 'whatsapp.contacts.create',
    httpMethod: 'post',
    httpPath: '/v1/whatsapp/contacts',
  },
  {
    clientCallName: 'client.whatsapp.contacts.retrieve',
    fullyQualifiedName: 'whatsapp.contacts.retrieve',
    httpMethod: 'get',
    httpPath: '/v1/whatsapp/contacts/{contact_id}',
  },
  {
    clientCallName: 'client.whatsapp.contacts.list',
    fullyQualifiedName: 'whatsapp.contacts.list',
    httpMethod: 'get',
    httpPath: '/v1/whatsapp/contacts',
  },
  {
    clientCallName: 'client.whatsapp.contacts.delete',
    fullyQualifiedName: 'whatsapp.contacts.delete',
    httpMethod: 'delete',
    httpPath: '/v1/whatsapp/contacts/{contact_id}',
  },
  {
    clientCallName: 'client.whatsapp.contacts.bulkOperations',
    fullyQualifiedName: 'whatsapp.contacts.bulkOperations',
    httpMethod: 'post',
    httpPath: '/v1/whatsapp/contacts/bulk',
  },
  {
    clientCallName: 'client.whatsapp.contacts.import',
    fullyQualifiedName: 'whatsapp.contacts.import',
    httpMethod: 'post',
    httpPath: '/v1/whatsapp/contacts/import',
  },
  {
    clientCallName: 'client.whatsapp.groups.create',
    fullyQualifiedName: 'whatsapp.groups.create',
    httpMethod: 'post',
    httpPath: '/v1/whatsapp/groups',
  },
  {
    clientCallName: 'client.whatsapp.groups.list',
    fullyQualifiedName: 'whatsapp.groups.list',
    httpMethod: 'get',
    httpPath: '/v1/whatsapp/groups',
  },
  {
    clientCallName: 'client.whatsapp.groups.delete',
    fullyQualifiedName: 'whatsapp.groups.delete',
    httpMethod: 'delete',
    httpPath: '/v1/whatsapp/groups/{group_id}',
  },
  {
