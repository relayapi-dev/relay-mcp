...
import Relay, { toFile } from '@relayapi/mcp';
...
describe('resource media', () => {
  ...
  test.skip('getPresignURL: only required params', async () => {
    const responsePromise = client.media.getPresignURL({ content_type: 'content_type', filename: 'filename' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('upload: only required params', async () => {
    const responsePromise = client.media.upload(await toFile(Buffer.from('Example data'), 'README.md'), { filename: 'filename' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('upload: required and optional params', async () => {
    const response = await client.media.upload(await toFile(Buffer.from('Example data'), 'README.md'), { filename: 'filename' });
  });
});
